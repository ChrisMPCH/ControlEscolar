using NLog; //name space para NLog
using NLog.Config; //name space para NLog
using NLog.Targets; //name space para NLog
...
namespace ControlEscolarCore.Utilities
{
    ...
    {
        private static bool _isConfigured = false; // Bandera para saber si ya se configuró NLog, variable global 
